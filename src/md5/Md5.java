...
public class Md5 {
	...
	public String md5(String s) {
		...
		ByteBuffer bb = ByteBuffer.allocate((((message.length + 8) / 64) + 1) * 64).order(ByteOrder.LITTLE_ENDIAN);
	    bb.put(message);
	    bb.put((byte)0x80);
	    long messageLenBits = (long)message.length * 8;
	    bb.putLong(bb.capacity() - 8, messageLenBits);
